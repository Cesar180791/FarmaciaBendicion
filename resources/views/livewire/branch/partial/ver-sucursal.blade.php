...
<div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
    <div class="bio layout-spacing ">
        <div class="widget-content widget-content-area">
            <h3 class="">Sucursal {{$nombreSucursal}}</h3>
            <img src="{{ asset('storage/sucursales/'.$imagenSucursal)}}" style="width: 500px; height: 300px"
                alt="avatar">
            ...
            <div class="bio-skill-box">
                ...
                <div class="row">
                    ...
                    <a href="javascript:void(0)" class="ml-auto mt-3 tabmenu btn btn-danger btn-sm text-white" id="regresar2"><b> Cerrar</b></a> 
                </div>
