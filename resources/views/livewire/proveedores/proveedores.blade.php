                     ...
                     <table class="table table-bordered table-striped mt-1">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td class="text-center"><span class="badge {{$proveedor->estado_proveedor == 'ACTIVO' ? 'badge-success' : 'badge-danger'}} text-uppercase">{{$proveedor->estado_proveedor}}</span></td>
                                 <td class="text-center">
                                     <a href="javascript:void(0)" wire:click.prevent="Edit({{$proveedor->id}})" class="mtmobile" title="Edit">
                                     ...
                                     <a href="javascript:void(0)" class="mtmobile" wire:click.prevent="Active({{$proveedor->id}})"  title="Activar">
                                     ...
                                     <a href="javascript:void(0)" class="mtmobile" onclick="Confirm('{{$proveedor->id}}', 'DeshabilitarProveedor', '¿Deshabilitar Proveedor?')" title="Delete">
